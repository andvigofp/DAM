    ...
    public static void CapturasNotas() {
       ...
       String notacad="";
        ...
        do {
            ...
            switch (nota) {
                case 1: System.out.println(nota + "");

                case 2: System.out.println(notacad + " ");
                case 3: System.out.println(notacad + " ");
                case 4: System.out.println(notacad + " Insufiente");
                break;
                case 5: System.out.println(notacad + " Suficiente");
                break;
                case 6: System.out.println(notacad + " Bien");
                break;
                case 7: System.out.println(notacad + " ");
                break;
                case 8: System.out.println(notacad + " Notable");

                case 9: System.out.println(notacad + " ");
                case 10: System.out.println(notacad + " Sobresaliente");
                break;
