// Pedir hora de trabajo
//Ordinograma y Pseudocódigo que calcule la nónima salarial neto,
// de unos obreros cuyo trabajo se paga en horas.
//El cálculo se realiza de la siguiente forma:
// - la primeras 35 horas mensuales a una tarifa fija. (30 ?, por ejemplo)
// - Las horas extra se pagan a 1.5 más de la tarifa fija (resto de horas * tarifa * 1.5)
...
SubProceso CalculoNonima (horasTrabajo)
	tarifa = 30;
